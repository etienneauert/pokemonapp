...
export class Pokemoncards {
  pokemons = [
    ...
    { name: 'Keldeo', image: '/PokemonBilder/Keldeo_Bild.png', audio: '/PokemonAudio/Keldeo_Audio.mp3' },
    { name: 'Genesect', image: '/PokemonBilder/Genesect_Bild.png', audio: '/PokemonAudio/Genesect_Audio.mp3' },
    { name: 'Diancie', image: '/PokemonBilder/Diancie_Bild.png', audio: '/PokemonAudio/Diancie_Audio.mp3' },
    { name: 'Hoopa', image: '/PokemonBilder/Hoopa_Bild.png', audio: '/PokemonAudio/Hoopa_Audio.mp3' },
    { name: 'Volcanion', image: '/PokemonBilder/Volcanion_Bild.png', audio: '/PokemonAudio/Volcanion_Audio.mp3' },
    { name: 'Magearna', image: '/PokemonBilder/Magearna_Bild.png', audio: '/PokemonAudio/Magearna_Audio.mp3' },
    ...
    { name: 'Melmetal', image: '/PokemonBilder/Melmetal_Bild.png', audio: '/PokemonAudio/Melmetal_Audio.mp3' },
    { name: 'Zarude', image: '/PokemonBilder/Zarude_Bild.png', audio: '/PokemonAudio/Zarude_Audio.mp3' },
